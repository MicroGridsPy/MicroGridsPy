...
*Scenarios 6–7 · demand grows +5 %/year · on-grid · two futures*
...
## Scenario 6 — Stochastic grid connection
...
![Grid availability by year for the two futures](../assets/examples/case6_grid_availability.png)
...
![Average-day dispatch in 2030 under the two futures](../assets/examples/case6_dispatch.png)
...
[capacity-expansion case](planning-for-growth.md#scenario-5-capacity-expansion):

| Quantity | Off-grid (Sc. 5) | Stochastic grid (Sc. 6) | Change |
|---|--:|--:|--:|
...
![Operating cost by future, with the probability-weighted expected value](../assets/examples/case6_expected_cost.png)
...
| Quantity | No carbon price (Sc. 6) | Carbon cost (Sc. 7) | Change |
|---|--:|--:|--:|
...
![Emissions by scope over the horizon](../assets/examples/case7_emissions.png)
