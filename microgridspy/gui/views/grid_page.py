...
def grid_technology() -> None:
    ...
    # st.image(str(image_path), width='stretch', caption="Overview of the grid connection parameters")
    ...
    if has_grid_connection:
        ...
        st.session_state.grid_connection_cost = st.number_input(f"Grid Connection Cost [{currency}/km]", min_value=0.0, value=st.session_state.grid_connection_cost)
