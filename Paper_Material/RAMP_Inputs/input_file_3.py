...
HI_bulb_new_1 = HI.Appliance(HI,3,12,2,360,0.2,2,year_min=4,initial_share=0)
HI_bulb_new_1.windows([480,600],[1140,1440],0.4)

HI_bulb_new_2 = HI.Appliance(HI,2,12,2,360,0.2,2,year_min=14,initial_share=0)
...
HI_Freezer_new = HI.Appliance(HI,1,250,1,1440,0,30,'yes',3,year_min=19,initial_share=0)
...
HI_ElHeater_new = HI.Appliance(HI,1,1500,2,360,0.2,30, thermal_P_var=0.4,year_min=14,initial_share=0)
HI_ElHeater_new.windows([300,480],[1080,1380],0.25)

HI_PC = HI.Appliance(HI,1,70,1,90,0.1,30)
HI_PC.windows([960,1440],[0,0],0.35)

HI_PC_new = HI.Appliance(HI,1,70,1,90,0.1,30, year_min=18,initial_share=0)
...
HI_Phone_charger_new = HI.Appliance(HI,2,5,2,480,0.2,60,year_min=6,initial_share=0)
...
HI_lunch1_soup = HI.Appliance(HI,1,1800,2,70,0.15,60, thermal_P_var = 0.2, pref_index =1, fixed_cycle=1, year_min = 8, initial_share = 0)
...
HI_lunch2_rice = HI.Appliance(HI,1,1800,2,25,0.15,20, thermal_P_var = 0.2, pref_index = 2, fixed_cycle=1, year_min = 8, initial_share = 0)
...
HI_lunch2_egg = HI.Appliance(HI,1,1200,2,3,0.2,3, thermal_P_var = 0.2 , pref_index = 2, year_min = 8, initial_share = 0)
HI_lunch2_egg.windows([12*60,15*60],[0,0],0.15)

HI_lunch2_platano = HI.Appliance(HI,1,1800,2,10,0.15,5, thermal_P_var = 0.2, pref_index = 2, fixed_cycle=1, year_min = 8, initial_share = 0)
...
HI_lunch2_meat = HI.Appliance(HI,1,1200,2,7,0.15,3, thermal_P_var = 0.2, pref_index = 2, year_min = 8, initial_share = 0)
HI_lunch2_meat.windows([12*60,15*60],[0,0],0.15)

HI_lunch3_beansnrice = HI.Appliance(HI,1,1800,2,45,0.2,30, thermal_P_var =0.2 , pref_index = 3, fixed_cycle=1, year_min = 8, initial_share = 0)
...
HI_lunch3_meat = HI.Appliance(HI,1,1200,2,10,0.2,5, thermal_P_var = 0.2, pref_index = 3, year_min = 8, initial_share = 0)
HI_lunch3_meat.windows([12*60,15*60],[0,0],0.15)

HI_lunch_yuca = HI.Appliance(HI,1,1800,1,25,0.15,10, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1, year_min = 8, initial_share = 0)
...
HI_breakfast_huminta = HI.Appliance(HI,1,1800,1,65,0.15,50, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1, year_min = 8, initial_share = 0)
...
HI_breakfast_bread = HI.Appliance(HI,1,1800,1,15,0.15,10, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1, year_min = 8, initial_share = 0)
...
MI_bulb_new = MI.Appliance(MI,3,12,2,360,0.2,2,year_min=10,initial_share=0)
MI_bulb_new.windows([480,600],[1140,1440],0.4)

MI_radio_new = MI.Appliance(MI,1,7,2,240,0.1,30,year_min=5,initial_share=0)
...
MI_ElHeater_new = MI.Appliance(MI,1,1500,2,360,0.2, 30,thermal_P_var=0.4,year_min=7,initial_share=0)
MI_ElHeater_new.windows([300,480],[1080,1380],0.25)

MI_PC_new = MI.Appliance(MI,1,70,1,90,0.1,30,year_min=10,initial_share=0)
...
MI_Phone_charger_new_1 = MI.Appliance(MI,1,5,2,480,0.2,60,year_min=5,initial_share=0)
MI_Phone_charger_new_1.windows([1200,1440],[0,420],0.35)

MI_Phone_charger_new_2 = MI.Appliance(MI,1,5,2,480,0.2,60,year_min=13,initial_share=0)
MI_Phone_charger_new_2.windows([1200,1440],[0,420],0.35)

MI_TV = MI.Appliance(MI,1,150,2,360,0.1,30)
MI_TV.windows([600,780],[1140,1380],0.4)

MI_TV_new = MI.Appliance(MI,1,150,2,360,0.1,30,year_min=17,initial_share=0)
MI_TV_new.windows([600,780],[1140,1380],0.4)

#MI_Class Cooking

MI_lunch1_soup = MI.Appliance(MI,1,1800,2,70,0.15,60, thermal_P_var = 0.2, pref_index =1, fixed_cycle=1, year_min = 13, initial_share = 0)
...
MI_lunch2_rice = MI.Appliance(MI,1,1800,2,25,0.15,20, thermal_P_var = 0.2, pref_index = 2, fixed_cycle=1, year_min = 13, initial_share = 0)
...
MI_lunch2_egg = MI.Appliance(MI,1,1200,2,3,0.2,3, thermal_P_var = 0.2 , pref_index = 2, year_min = 13, initial_share = 0)
MI_lunch2_egg.windows([12*60,15*60],[0,0],0.15)

MI_lunch2_platano = MI.Appliance(MI,1,1800,2,10,0.15,5, thermal_P_var = 0.2, pref_index = 2, fixed_cycle=1, year_min = 13, initial_share = 0)
...
MI_lunch2_meat = MI.Appliance(MI,1,1200,2,7,0.15,3, thermal_P_var = 0.2, pref_index = 2, year_min = 13, initial_share = 0)
MI_lunch2_meat.windows([12*60,15*60],[0,0],0.15)

MI_lunch3_beansnrice = MI.Appliance(MI,1,1800,2,45,0.2,30, thermal_P_var =0.2 , pref_index = 3, fixed_cycle=1, year_min = 13, initial_share = 0)
...
MI_lunch3_meat = MI.Appliance(MI,1,1200,2,10,0.2,5, thermal_P_var = 0.2, pref_index = 3, year_min = 13, initial_share = 0)
MI_lunch3_meat.windows([12*60,15*60],[0,0],0.15)

MI_lunch_yuca = MI.Appliance(MI,1,1800,1,25,0.15,10, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1, year_min = 13, initial_share = 0)
...
MI_breakfast_huminta = MI.Appliance(MI,1,1800,1,65,0.15,50, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1, year_min = 13, initial_share = 0)
...
MI_breakfast_bread = MI.Appliance(MI,1,1800,1,15,0.15,10, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1, year_min = 13, initial_share = 0)
...
LI_Freezer_new = LI.Appliance(LI,1,250,1,1440,0,30,'yes',3, year_min = 4, initial_share=0)
...
LI_radio_new = LI.Appliance(LI,1,7,2,240,0.1,30,year_min=7,initial_share=0)
...
LI_ElHeater_new = LI.Appliance(LI,1,1500,2,360,0.2,30,thermal_P_var=0.4,year_min=13,initial_share=0)
...
LI_mate_new = LI.Appliance(LI,1,1600,1,30,0.3,2, thermal_P_var = 0.2, pref_index =0, year_min=8, initial_share= 0)
