...
class Model:
    ...
    def solve_multi_objective(self, num_points: int) -> List[Tuple[float, float]]:
        ...
        cost_solution = self._solve()
        max_co2 = cost_solution.objective_value
        ...
        emissions_solution = self._solve()
        min_co2 = emissions_solution.objective_value
        ...
        for i in range(num_points):
            ...
            self.model.add_constraint(emissions_objective <= emission_threshold, name=f"co2_threshold_{i}")
