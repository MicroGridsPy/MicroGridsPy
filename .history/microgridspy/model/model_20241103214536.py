...
class Model:
    ...
    def solve_multi_objective(self, num_points: int):
        ...
        self.model.add_objective(emissions_objective)
        solution = self._solve()
        min_co2 = solution.get(objective_variable).values
        solutions.append(solution)
