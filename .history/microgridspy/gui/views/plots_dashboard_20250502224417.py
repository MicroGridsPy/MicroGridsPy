...
def plots_dashboard():
    ...
    if 'multiobjective_solutions' in st.session_state:
        ...
        add_emission_row("Renewables Installation", "res_emission")
        if model.has_battery:
            add_emission_row("Battery Installation", "battery_emission")
        if model.has_generator:
            add_emission_row("Generator Installation", "gen_emission")
