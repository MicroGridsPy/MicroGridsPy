...
def run_model():
    ...
    st.write("""
    Choose your solver and run the optimization process. By default, the model will save the LP representation in the project folder,
    but you can specify a different path if needed.
    """)
    ...
    if use_custom_path:
        ...
        st.write("Specify a custom name for saving the LP representation of the model:")
