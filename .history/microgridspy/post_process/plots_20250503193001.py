...
def dispatch_plot(model: Model, scenario: int, year: int, day: int, color_dict: dict):
    ...
    ax.set_title(f'Energy Balance - Year {year + 1}, Day {day + 1}', fontsize=18, fontweight='bold')
    ax.legend(loc='upper left', fontsize=12, framealpha=0.8, fancybox=True, frameon=True)
    ax.grid(True)
