...
class RECalculationPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.title_label = ttk.Label(self.inner_frame, text="Endogenous RES Time Series Calculation", font=self.subtitle_font)
        ...
        for i, (param, value) in enumerate(self.re_calc_params.items(), start=6):  
            label_text = param
