...
Plot = Time_Series['Renewable Energy 1'] #The variable Time_Series must have been previously created as a result of model solving
...
plt.fill_between(x,0,(Plot_series[day_start:day_end].values[:,0]/71100), facecolor='r', alpha=0.3,label='PV unitary output')
